...
Ultimately, the script saves the dataframes used in behavioural and modeling analyses. 
...
#### 4.2 Social
```{r}
#participant nr 40 missing in food data (exclude here for comparability)
data_social_hungry<-subset(data_social_hungry, subject != 40)
data_social_sated<-subset(data_social_sated, subject != 40)
data_social_hungry_long<-subset(data_social_hungry_long, subject != 40)
data_social_sated_long<-subset(data_social_sated_long, subject != 40)
...
```{r}
#participant nr 40 missing in food data (exclude here for comparability)
data_discount_hungry<-subset(data_discount_hungry, subject != 40)
data_discount_sated<-subset(data_discount_sated, subject != 40)
data_discount_hungry_long<-subset(data_discount_hungry_long, subject != 40)
data_discount_sated_long<-subset(data_discount_sated_long, subject != 40)

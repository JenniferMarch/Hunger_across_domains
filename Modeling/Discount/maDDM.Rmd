...
save.image(file="DDM_discount.RData")
```
...
# Plot using ggplot2
amount_weight1<-ggplot(datatw, aes(x = weight1_S)) +
  geom_histogram(binwidth = 1/850, fill = "cornflowerblue", alpha = 0.5, color = "black") +
  geom_histogram(aes(x = weight1_H), binwidth = 1/850, fill = "gold", alpha = 0.5, color = "black") +
...
# Plot using ggplot2
amount_weight2<-ggplot(data_deltatw, aes(x = weight1_delta)) +
  geom_histogram(binwidth = 1/15, fill = "grey", alpha = 0.5, color = "black") +
...
combined_plot_ddm1 <- plot_grid(amount_weight1, amount_weight2, drift1, drift2, nDT1, nDT2, bound1, bound2, labels = c("a", "", "b", "", "c", "", "d", ""), label_size = 20, ncol = 4, align = "h", column_spacing = unit(c(0, 0, 2, 0), "cm"))
combined_plot_ddm1
# Save the combined plot as a PNG file
ggsave("ddm_discount.png", combined_plot_ddm1, width = 16, height = 12)
```

...
for (s in (unique(data_discount_hungry$subject))){
  ...
  for (t in 1:2){
    ...
    fixProp1_s <- sub$timeleft_time/(sub$valueleft_time+sub$valueright_time+sub$timeleft_time+sub$timeright_time)#time left
    fixProp2_s <- sub$timeright_time/(sub$valueleft_time+sub$valueright_time+sub$timeleft_time+sub$timeright_time)#time right
    fixProp3_s <- sub$valueleft_time/(sub$valueleft_time+sub$valueright_time+sub$timeleft_time+sub$timeright_time) #value left
    fixProp4_s <- sub$valueright_time/(sub$valueleft_time+sub$valueright_time+sub$timeleft_time+sub$timeright_time)#value right
    
    fixProps <- matrix(c(fixProp1_s*(valueL==T)+fixProp2_s*(valueL==F),fixProp1_s*(valueL==F)+fixProp2_s*(valueL==T),
                   fixProp3_s*(valueL==T)+fixProp4_s*(valueL==F),fixProp3_s*(valueL==F)+fixProp4_s*(valueL==T)),ncol=4)

...
# try Jenna's
# load("../Social/data_social_prep.RData")
...
#ddm_results <- maaDDM_social
ddm_results <- maa2phiDDM_social
...
est_parameters <- list(
  list(name = "weight1", label = "Self Weight", binwidth = 1/1000, maxY = 500),
  list(name = "drift", label = "Drift Scaling", binwidth = 1/1000, maxY = 500),
  list(name = "boundSep", label = "Boundary Separation", binwidth = 1/1000, maxY = 500),
  list(name = "ndt", label = "Non-Decision Time", binwidth = 1/1000, maxY = 500),
  list(name = "theta", label = "Theta", binwidth = 1/1000, maxY = 500),
  list(name = "phy", label = "phy", binwidth = 1/1000, maxY = 250),
  list(name = "phy2", label = "phy2", binwidth = 1/1000, maxY = 250)
)

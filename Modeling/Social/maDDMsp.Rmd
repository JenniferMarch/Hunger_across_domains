...
save.image(file="DDMsp_social.RData")
```
...
selfweight1<-ggplot(datatw, aes(x = weight1_S)) +
  geom_histogram(binwidth = 1/60, fill = "cornflowerblue", alpha = 0.5, color = "black") +
  geom_histogram(aes(x = weight1_H), binwidth = 1/60, fill = "gold", alpha = 0.5, color = "black") +
...
combined_plot_ddm2 <- plot_grid(selfweight1, selfweight2, drift1, drift2, nDT1, nDT2, bound1, bound2, startpoint1, startpoint2, labels = c("a", "", "b", "", "c", "", "d", "", "e", ""), label_size = 20, ncol = 4, align = "h", column_spacing = unit(c(0, 0, 2, 0, 0), "cm"))
combined_plot_ddm2
# Save the combined plot as a PNG file
ggsave("ddmsp_social.png", combined_plot_ddm2, width = 16, height = 12)
```
